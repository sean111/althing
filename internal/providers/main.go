...
var SYSTEM_PROMPT = "Make sure all answers are clear and concise. Make sure answers are fully readable by other LLMs and do NOT include any extra formatting. Use any available tools to check to make sure your knowledge is correct"
